...
- [x] 5.1 `npx supabase migration list` shows no remote drift before the push — 23d55ae
- [x] 5.2 `npx supabase db push` exits 0 — 23d55ae
- [x] 5.3 `npx supabase migration list` shows local and remote in sync — 23d55ae

#### Manual

- [x] 5.4 Studio on the cloud project shows all five tables with RLS enabled and no `public` functions or triggers — 23d55ae
- [x] 5.5 Signing in to the deployed app still works — 23d55ae
- [x] 5.6 A signed-out `select` against `medications` returns zero rows, not data — 23d55ae
- [x] 5.7 Migration filename, date applied, and project ref recorded in `change.md` — 23d55ae
